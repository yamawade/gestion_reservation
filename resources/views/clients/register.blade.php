        ...
        <form action="/inscriptionClient" method="post">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label for="nomUser" class="form-label mt-4">Nom</label>
                    <input type="text" class="form-control" id="nomUser" name="nom">
                </div>
                <div class="form-group">
                    <label for="prenomUser" class="form-label mt-4">Prénom</label>
                    <input type="text" class="form-control" id="prenomUser" name="prenom">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="telephoneUser" class="form-label mt-4">Téléphone</label>
                    <input type="text" class="form-control" id="telephoneUser" name="telephone">
                </div>
                <div class="form-group">
